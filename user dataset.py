...
Original file is located at
    https://colab.research.google.com/drive/1GaormjoM2HWDVrd72WRYP0zczYblqN8a
"""
...
df=pd.read_csv("/content/drive/MyDrive/User_Data (3).csv")
...
if len(numerical_cols) <=5:
  ...
  print(f"Too many numerical columns ({len(numerical_cols)}) for pairplot. Try subset.")

for col in categorical_cols:
  print(f"\n=== {col} ===")
  print("Value Counts:")
  print(df[col].value_counts())
  print("/nPercentage distribution:")
